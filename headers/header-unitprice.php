            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="home.php" id="dashboard" ><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li id="products">
                            <a href="#" class="active"><i class="fa fa-bar-chart-o fa-fw"></i> Product Details </a>
                            <ul class="nav nav-second-level" id="nav-second-level">
                                <li>
                                    <a href="add_unit_price.php" id="unit_price" class="active">Add Unit Price</a>
                                </li>
                                <li>
